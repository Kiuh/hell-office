...
% =====================================================================================================================
\documentclass[a4paper,14pt,oneside,final]{report}  % Класс документа
...
\newfontfamily\cyrillicfonttt{Courier New}[Ligatures=TeX]   % Моноширинный шрифт
...
\sisetup{
  binary-units = true,          % Двоичные единицы (КиБ, МиБ)
...
\bibliographystyle{belarus-specific-utf8gost780u}               % Стиль ГОСТ
